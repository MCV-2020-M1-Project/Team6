...
def get_descriptors(img, mask=None):
    ...
    # descript_dic['DCT-8-32'] = get_DCT_coefs(img, N=8, block_w=32)
    descript_dic['DCT-4-64'] = get_DCT_coefs(img, N=4, block_w=64)
    descript_dic['DCT-8-64'] = get_DCT_coefs(img, N=8, block_w=64)
